...
class System(Information):
    ...
    def set_controlDict(self, *lists: dict, **options) -> None:
        ...
        Return: None
        """
        self.set_any_file(*lists, files=("controlDict",), **options)
    ...
    def set_fvSolution(self, *lists: dict, **options) -> None:
        ...
        Return: None
        """
        self.set_any_file(*lists, files=("fvSolution",), **options)
    ...
    def set_fvSchemes(self, *lists: dict, **options) -> None:
        ...
        Return: None
        """
        self.set_any_file(*lists, files=("fvSchemes",), **options)

    def set_any_file(self, *lists_var: dict, files=("controlDict",), **options) -> None:
