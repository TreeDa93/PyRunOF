...
d = parameters['d_var'] # diameter of obstacle_turb_models_pisoFoam_in_progress
...
#Creation of obstacle_turb_models_pisoFoam_in_progress
...
circle_edge = Mesh_2D.GroupOnGeom(circle_edge,'circle_wall',SMESH.EDGE)
